...
Megatron is released as open source using the Apache license within the EGC 
community. CERT-SE does not provide any kind of support, but answers of course
